...
* Execution date: 2022-11-10 11:03:45.927189
...
### Method 1 - Imputing with mean values for 2 stations (363 missing values & 363 imputed)

![R.LTWB](Impute_Mean_Outlier_IQR_Cap_Pivot_PTPM_TT_M.csv.png)

### Method 2 - Imputing with median values for 2 stations (363 missing values & 363 imputed)

![R.LTWB](Impute_Median_Outlier_IQR_Cap_Pivot_PTPM_TT_M.csv.png)

### Method 3 - Imputing with LOCF values for 2 stations (363 missing values & 75 imputed)
