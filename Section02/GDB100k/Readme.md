...
|     2     | En el documento soporte de desarrollo, incluya una tabla indicando las coordenadas de las localizaciones donde se realizaron ajustes y presente capturas de pantalla detalladas de los ajustes manuales realizados a la red de drenaje, p.ej. en conexiones laterales a drenajes dobles o cauces obtenidos como polígonos, ejes de drenaje y líneas conectoras en embalses y cuerpos de agua de gran extensión, descarga de embalses a cauces principales receptores, apertura de bucles y ajustes de conexiones erradas.<br><br>En la red de drenaje final no deben existir:<br> * Bucles o circuitos cerrados<br>* Drenajes huérfanos<br>* Sistemas lénticos sin lineas conectoras centrales o desconectadas de la red de drenaje<br>* Sistemas lóticos sin líneas centrales para drenajes digitalizados como polígonos, correspondientes a espejos de agua.<br><br>Nota: verifique qué el cauce principal sea contínuo a través de toda la cuenca y en la zona del límite final aguas abajo, recorte la línea para que coincida con el borde del polígono de la zona de estudio. Por tratarse de una red de drenaje para balance hidrológico de largo plazo, no es necesario revisar o ajustar el sentido vectorial de las líneas. |
|     3     | Utilizando el ArcToolBox _ToolboxCheckNetworkConnections.tbx_ disponible en esta actividad, seleccione en ArcGIS For Desktop el último tramo aguas abajo de la red de drenaje y ejecute la herramienta CheckNetworkConnections, podrá observar luego de la ejecución todos aquellos tramos de drenaje huerfanos o desconectados de la red de drenaje interna de la zona de estudio. El iterador de selección ha sido establecido en 100 veces.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|     4     | Investigue y documente otros servicios en línea desde donde se puedan obtener vectores de drenaje (p. ej. [IDECA](https://www.ideca.gov.co/), [CAR Cundinamarca - Colombia](https://www.car.gov.co/), [ESRI](https://datosabiertos.esri.co/)). Descargue y compare con los disponibles en el IGAC - Colombia y con fotografías satelitales actualizadas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
