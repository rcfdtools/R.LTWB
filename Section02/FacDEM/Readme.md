...
<div style="width:80%"><sub><p style="line-height:75%">Convenciones generales en diagramas: clases de entidad en azul, dataset en gris oscuro, grillas en color verde, geo-procesos en rojo y procesos manuales en amarillo. Líneas con guiones corresponden a procedimientos opcionales.</p>></sub></div>><br><br>
</div>
