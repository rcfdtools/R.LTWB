...
<div align="center">
<br><img alt="R.LTWB" src="Screenshot/MicrosoftExcel365StrDEM.png" width="65%">
<br><img alt="R.LTWB" src="Screenshot/MicrosoftExcel365StrDEMGraph.png" width="65%"><br>
</div>
...
<div align="center">
<br><img alt="R.LTWB" src="Graph/StrDEMFlowchart.svg" width="65%"><br>
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMASTERLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMASTER.png)

Resultados, ventana de ejecución grilla SRTM (dt: 00'05.72")
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMSRTMLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMSRTM.png)

Resultados, ventana de ejecución grilla ALOS (dt: 42'24.63")
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMALOSParameters.png)  
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMALOSLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2HECGeoHMSStrDEMALOS.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2RasterToPolylineStrDEMASTERLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2RasterToPolylineStrDEMASTER.png)

Resultados, ventana de ejecución grilla SRTM (dt: 04'39")
![R.LTWB](Screenshot/ArcGISDesktop10.2.2RasterToPolylineStrDEMSRTMLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2RasterToPolylineStrDEMSRTM.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2FeatureVerticesToPointsStrDEMASTERLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2FeatureVerticesToPointsStrDEMASTER.png)
![R.LTWB](Screenshot/ArcGISPro3.0.0FeatureVerticesToPointsStrDEMASTER.png)

Resultados, ventana de ejecución grilla SRTM con 65688 nodos (dt: 00'18.80")
![R.LTWB](Screenshot/ArcGISDesktop10.2.2FeatureVerticesToPointsStrDEMSRTMLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2FeatureVerticesToPointsStrDEMSRTM.png)

Resultados, ventana de ejecución grilla ALOS con 72210 nodos (dt: 00'35.67")
![R.LTWB](Screenshot/ArcGISDesktop10.2.2FeatureVerticesToPointsStrDEMALOSLog.png)
![R.LTWB](Screenshot/ArcGISDesktop10.2.2FeatureVerticesToPointsStrDEMALOS.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2CalculateGeometry.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2DeleteIdenticalParameters.png)  
![R.LTWB](Screenshot/ArcGISDesktop10.2.2DeleteIdenticalStrDEMASTER.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2ExtractMultiValuestoPointsSRTMFac.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2ExtractMultiValuestoPointsALOSFac.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2AddFieldArea.png)
...
![R.LTWB](Screenshot/ArcGISDesktop10.2.2LabelASTERStrNode.png)

Áreas de aportación por nodo para acumulaciones SRTM
![R.LTWB](Screenshot/ArcGISDesktop10.2.2LabelSRTMStrNode.png)

Áreas de aportación por nodo para acumulaciones ALOS
![R.LTWB](Screenshot/ArcGISDesktop10.2.2LabelALOSStrNode.png)
...
![R.LTWB](Screenshot/QGIS3.26.0RasterCalculatorStrDEMASTER.png)
