...
|     2     | A partir del polígono que delimita la zona hidrográfica en estudio (ZonaEstudio.shp), calcule la densidad, cobertura y radio de acción, y compare los resultados obtenidos con los del polígono buffer a partir del cual se seleccionaron las estaciones dentro y al rededor de la zona de estudio para cada grupo de estaciones por variable climatológica . | 
...
|     4     | Investigue, documente e implementa al menos una metodología adicional para el análisis de densidad de estaciones.                                                                                                                                                                                                                                             | 
