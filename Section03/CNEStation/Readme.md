...
|     4     | Utilizando la herramienta [CNEStationSelect](https://github.com/rcfdtools/R.HydroTools/tree/main/CNEStationSelect), realice el procedimiento de selección de estaciones para estudios hidrológicos y compare con el procedimiento presentado en esta clase.                        | 
