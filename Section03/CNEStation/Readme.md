...
### Atributos que componen el catálogo nacional de estaciones y especificaciones
...
|     5     | Utilizando Python, cree una herramienta que homologue los atributos de cualquier catálogo de estaciones al formato del Catálogo Nacional de Estaciones de Colombia - CNE. El homologador debe escribir los datos en el mismo orden que contiene el CNE.                                                                                                        |
...
| [Anterior](https://github.com/rcfdtools/R.LTWB/tree/main/Section02/StrDEM)  | [:house: Inicio](https://github.com/rcfdtools/R.LTWB/wiki) | [:beginner: Ayuda](https://github.com/rcfdtools/R.LTWB/discussions/14) | [Siguiente](https://github.com/rcfdtools/R.LTWB/tree/main/Section03/CNEStationElevation) |
|-----------------------------------------------------------------------------|------------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
