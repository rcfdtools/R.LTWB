...
|     4     | Utilizando la herramienta [CNEStationSelect](https://github.com/rcfdtools/R.HydroTools/tree/main/CNEStationSelect) del repositorio [R.HydroTools](https://github.com/rcfdtools/R.HydroTools), realice el procedimiento de selección de estaciones para estudios hidrológicos y compare con el procedimiento presentado en esta clase. | 
