...
|     3     | En el archivo integrado _IDEAMJoined.csv_, verifique manualmente que en todos los registros el formato de fechas y horas sea consistente en los campos `FechaInstalacion`, `FechaSuspension` y `Fecha`. Si la fecha de una columna específica esta registrada en formato aaaa//mm/dd, todos los registros para el mismo campo deben conservar el mismo formato. | 
