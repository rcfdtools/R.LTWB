...
# 4.3. Mapa de evapotranspiración potencial - ETP
...
<div align="center">
<br><img alt="R.LTWB" src="Graph/ETP.svg" width="30%"><br>
...
* Grilla :open_file_folder:: [Part1](../../file/grid/ETPCenicafe.part01.rar), [Part2](../../file/grid/ETPCenicafe.part02.rar), [Part3](../../file/grid/ETPCenicafe.part03.rar)  
...
|     2     | A partir de las ecuaciones regionales investigadas, cree los mapas de evapotranspiración potencial y con algebra de mapas realice el análisis de diferencias respecto a los mapas obtenidos en esta actividad. Evalúe e implemente en su caso de estudio, los mapas que mejor representen su zona de estudio. |
...
| [◄ Anterior](../Temperature/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.LTWB/discussions/30) | [Siguiente ►](../ETR/Readme.md) |
|----------------------------------------|---------------------------|------------------------------------------------------------------------|--------------------------------|
