...
* [:construction_worker:Cuenta de usuario GitHub](https://github.com/) para acceso a recursos y actualizaciones del repositorio público del curso.
...
* Cuenta de usuario en [Eathdata](../UserCreation) de la NASA.
...
|----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|------------------------------------------------------------------|
| [datasets](../../file/datasets)             | Tablas y series de datos base y generados                                                                                                                                                                                                                                                                                                    | CHIRPS, ENSOONI, IDEAM, IDEAM_Agg, IDEAM_EDA, IDEAM_Impute, IDEAM_Outlier | .xls, .xlsx, .dbf, .csv, .png, .md, .zip                         |
| [dem](../../file/dem)                       | Grillas base y grillas producidas de los modelos digitales de elevación                                                                                                                                                                                                                                                                      | ALOS, ASTER, SRTM                                                         | .tif, .rar                                                       |
| [gdb](../../file/gdb)                       | GDB descargada del Instituto Geográfico Agustín Codazzi - IGAC de Colombia - Suramérica                                                                                                                                                                                                                                                      | N/A                                                                       | .gdb                                                             |
| [grid](../../file/.grid)                    | Grillas en formato GeoTIFF producidas en la sección 4 y 5 de este curso, relacionadas con el análisis espacial de variables climatológicas y mapas de isorendimientos                                                                                                                                                                        | N/A                                                                       | .tif, .rar                                                       |
| [icons](../../file/graph)                   | Graficos e iconografía general de este repositorio                                                                                                                                                                                                                                                                                           | N/A                                                                       | .png, .cdr, .glb, .svg                                           |
| [map](../../file/map)                       | Mapas de documento y proyectos geográficos creados en aplicaciones SIG                                                                                                                                                                                                                                                                       | ArcGISPro, ArcGISProSection03, ArcGISProSection04, ArcGISProSection05     | .mxd, .sxd, .aprx, .qgz, .zip                                    |
| [projectionfile](../../file/projectionfile) | Archivos independientes de proyección de coordenadas en formato .prj aplicables a Colombia - Suramérica                                                                                                                                                                                                                                      | N/A                                                                       | .prj                                                             |
| [ref](../../file/refs)                      | Documentos y artículos de uso libre descargados y citados en la documentación o en las referencias particulares de las diferentes actividades                                                                                                                                                                                                | GitHubRefs                                                                | .pdf, .zip                                                       |
| [shp](../../file/shp)                       | Vectores base y vectores producidos en formato Shapefile (.shp)                                                                                                                                                                                                                                                                              | N/A                                                                       | .shp, .zip                                                       |
| [src](../../file/src)                       | Scripts independientes de uso general en lenguaje Python y Shell script                                                                                                                                                                                                                                                                      | N/A                                                                       | .py, .sh, .zip                                                   |
| [temp](../../file/temp)                     | Archivos ejemplo y archivos temporales generados en procesos intermedios                                                                                                                                                                                                                                                                     | N/A                                                                       | .xlsx, .md                                                       |
| [temp](../../file/hec)                      | Modelos hidrológicos en HEC. _HECGeoHMS/Layers_ contiene los archivos generados durante el proceso de preprocesamiento hidrológico de los modelos digitales de elevación - DEM. _HECHMS_ contiene los archivos del modelo prototipo hidrológico HEC-HMS, utilizados para el reacondicionamiento del modelo digital de elevación ASTER GDEM   | N/A                                                                       | .xlsx, .md                                                       |
...
| [◄ Anterior](../WhatIsLTWB/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.LTWB/discussions/39) | [Siguiente ►](../CaseStudy/Readme.md) |
|---------------------------------------|-----------------------------------|-----------------------------------------------------------------------------------|--------------------------------------|
