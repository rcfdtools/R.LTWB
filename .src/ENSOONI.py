...
ax = df_out.plot(y='EventMark',  color='silver', legend=False, figsize=(fig_size*2.5, fig_size*2), kind='line', grid=True, style='.-', ms=12, mfc='silver', mec='silver', linewidth=0.25)
